...
export const mainPage = localStorageStore<"surveys" | "options">("mainPage", "surveys");
export const surveyPage = localStorageStore<"entries" | "configs" | "options">("surveyPage", "entries");
