...
$(".crement-btn").addClass("w3-button w3-border w3-ripple").click(e => crement(e.target.id));
$(".toggle-btn").addClass("w3-button w3-border w3-ripple w3-margin-right w3-margin-bottom").click(e => toggle(e.target.id));
...
function getValuesStr() {
    ...
    else values.push(tubSup, bunCount, tubCount, bunSpl, cubCount,
        $("#penalty").prop("selectedIndex"), $("#drive").prop("selectedIndex"),
        $("#defense").prop("selectedIndex"), $("#comment").val(), $("#breakdown").val());
    let output = "";
